import {greatGreetingMess, ManType} from "./05_01";

let people: ManType[]//по умолчанию пустой массив

beforeEach(()=>{//функция для наших как бы данных
    people = [
...
test("should get array of greeting messages", ()=>{
    const messages = greatGreetingMess(people)
